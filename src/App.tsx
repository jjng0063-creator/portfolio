...
import { IS_PLACEHOLDER, NAV_SECTIONS, PORTFOLIO_DATA, drawerFiles } from './data/portfolioData';
...
export function App() {
  ...
  return (
    <>
      ...
      <CabinetStage bands={bands} drawers={drawers} theme={theme} />
